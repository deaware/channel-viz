(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'N5wFL4KQQYtCCfIeGRKMgCBHlJLHEw4mqCp0oxB8oPZQw4Bz', // Unique master Xively API key to be used as a default
		defaultFeeds	= [240990314], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Deaware', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
